package Practico5.ecommerce_site.tests;

import com.github.javafaker.Faker;
import Practico5.ecommerce_site.Constants;
import Practico5.ecommerce_site.page_objects.*;
...
public class ecommerceTest {
    ...
    public void registrationTest() throws InterruptedException {
        ...
        org.testng.Assert.assertEquals(driver.findElement(By.cssSelector("#uniform-id_gender1 span")).getAttribute("class"), "checked");
        org.testng.Assert.assertEquals(driver.findElement(By.id("firstname")).getAttribute("value"), fakeFirstName);
        org.testng.Assert.assertEquals(driver.findElement(By.id("lastname")).getAttribute("value"), fakeLastName);

        org.testng.Assert.assertEquals(driver.findElement(By.id("email")).getAttribute("value"), emailString);
        org.testng.Assert.assertTrue(driver.findElement(By.cssSelector("#uniform-days span")).getText().contains(Constants.BIRTH_DAY));
        ...
        org.testng.Assert.assertTrue(driver.findElement(By.cssSelector("#uniform-years span")).getText().contains(Constants.BIRTH_YEAR));
        ...
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains("MYALIAS"));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains(fakeCompany));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains(Constants.FIRST_ADDRESS));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains(Constants.SECOND_ADDRESS));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains(Constants.CITY));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains("Mexico"), "Se esperaba que se encuentre el pais 'Mexico' dentro de la direccion.");
        /*org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains("10000"));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains("United States"));
        org.testng.Assert.assertTrue(driver.findElement(By.className("bloc_adresses")).getText().contains("123456"));
    ...
    public void loginTest(){
        ...
        logoutBtn.click();
        loginBtn.click();
        emailLoginField.sendKeys(emailString);
        passwdLoginField.sendKeys(Constants.PASSWORD);
