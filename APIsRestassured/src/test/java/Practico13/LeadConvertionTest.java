...
public class LeadConvertionTest {
    ...
    public void updateLeadTitleTest(){
        //update the lead...
    ...
    public void convertLeadTest(){
        ...
        convertedAccountId = leadInfoJsonPath.get("ConvertedAccountId");
        convertedContactId = leadInfoJsonPath.get("ConvertedContactId");
    ...
    @Test (dependsOnMethods = "convertLeadTest")
    public void getConvertedAccountTest(){
        ...
        Assert.assertEquals(accountName, leadCompany, "Error: el account name deberia coincidir con el lead company");
    ...
    public void getConvertedContactTest(){
        ...
        Assert.assertEquals(contactName, leadName, "Error: el contact name deberia coincidir con el lead name");

        String accountTitle = contactJsonPath.get("Title");
        Assert.assertEquals(accountTitle, "QA Manager", "Error: el contact title  deberia ser QA Manager");
